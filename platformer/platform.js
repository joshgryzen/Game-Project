...
//         // Stop Jumping
//         if (this.player.jumpDown && !keysDown['ArrowUp'] && !keysDown['w']) {
...
class SwordComponent extends Component {
    ...
    update() {
        ...
        if (playerComponent.player.x_v >= 0) {
            this.transform.x = playerComponent.transform.x - 3
            this.transform.y = playerComponent.transform.y + 1
        } else {
            this.transform.x = playerComponent.transform.x - 3
            this.transform.y = playerComponent.transform.y + 1
        }
        ...
        if (keysDown[' '] && this.sword.canSwing && !this.sword.isSwinging) {
            console.log('hi')
            this.swingTime = 0
...
class MainScene extends Scene {
    ...
    start() {
        ...
        this.addGameObject(
            new GameObject('SwordGameObject')
                .addComponent(new SwordComponent())
                .addComponent(new Line('black'))
        )
        // this.addGameObject(
